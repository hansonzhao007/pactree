...
public:
    ...
    static void enqPerThreadLog (OpStruct::Operation op, Key_t key, uint8_t hash,
                                 void* listNodePtr);
    ...
    static void writeOpLog (OpStruct* oplog, OpStruct::Operation op, Key_t key, void* oldNodeRawPtr,
                            uint16_t poolId, Key_t newKey, Val_t newVal);
};
extern std::set<Oplog*> g_perThreadLog;
extern boost::lockfree::spsc_queue<std::vector<OpStruct*>*, boost::lockfree::capacity<10000>>
