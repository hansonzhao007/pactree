...
public:
    ...
    static void insertAndUnlock (N* node, N* parentNode, uint8_t keyParent, uint8_t key,
                                 pptr<N> val, ThreadInfo& threadInfo, bool& needRestart,
                                 OpStruct* oplog, uint32_t genId);

    static void change (N* node, uint8_t key, pptr<N> val);

    static void removeAndUnlock (N* node, uint8_t key, N* parentNode, uint8_t keyParent,
    ...
    static void insertGrow (curN* n, N* parentNode, uint8_t keyParent, uint8_t key, pptr<N> val,
                            ThreadInfo& threadInfo, bool& needRestart, OpStruct* oplog,
                            uint32_t genId);
